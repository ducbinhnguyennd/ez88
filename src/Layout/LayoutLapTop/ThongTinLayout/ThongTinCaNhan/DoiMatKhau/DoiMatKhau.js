...
function DoiMatKhau () {
  const [ismkcu, setIsmkcu] = useState(false)
  const [ismkmoi, setIsmkmoi] = useState(false)
  const [isnhaplaimk, setIsnhaplaimk] = useState(false)
  const [isMapin, setisMapin] = useState(false)
  return (
    <div className='doimatkhaucn_container'>
      <div className='doimatkhaucn_header'>
        Thay đổi mật khẩu giúp tăng cường bảo mật cho tài khoản của bạn.
      </div>
        ...
        <form action=''>
          <label htmlFor='' className='doimatkhaucn_label'>
            <div className='doimatkhaucn_inputgroup'>
              ...
              <input
                type={ismkcu ? 'text' : 'password'}
                placeholder='Mật khẩu cũ'
              />
              <span onClick={() => setIsmkcu(!ismkcu)}>
                {ismkcu ? (
                  <svg
                    stroke='currentColor'
                    fill='currentColor'
          ...
          <label htmlFor='' className='doimatkhaucn_label'>
            <div className='doimatkhaucn_inputgroup'>
              ...
              <input
                type={ismkmoi ? 'text' : 'password'}
                placeholder='Mật khẩu mới'
              />
              <span onClick={() => setIsmkmoi(!ismkmoi)}>
                {ismkmoi ? (
                  <svg
                    stroke='currentColor'
                    fill='currentColor'
          ...
          <label htmlFor='' className='doimatkhaucn_label'>
            <div className='doimatkhaucn_inputgroup'>
              ...
              <input
                type={isnhaplaimk ? 'text' : 'password'}
                placeholder='Nhập lại mật khẩu mới'
              />
              <span onClick={() => setIsnhaplaimk(!isnhaplaimk)}>
                {isnhaplaimk ? (
                  <svg
                    stroke='currentColor'
                    fill='currentColor'

    ...
    <div className='modaldangnhap'>
      ...
      <div className='modaldangnhap_main'>
        <div className='Dialog_popup__VKsaz'>
          ...
          <h4 class='Dialog_titlePopup__3iBru'>Đăng xuất tài khoản?</h4>
          <p class='Dialog_note__kz7NT'>
          ...
          <div className='Dialog_groupBtnPopup__SHV_R'>
            <div class='Button_container__By3IT Button_maxContent__29WwM'>
              <div class='Button_grey__1tZKm Button_rounded_6__tsqKR Button_maxContent__29WwM Button_small__ZiSjz Button_btn__z_3IU click'>
                <div class='Button_text__FcN3u' onClick={onClose}>
                  Huỷ
                </div>
              </div>
            </div>
            <div class='Button_container__By3IT Button_maxContent__29WwM'>
              <div class='Button_primary__8ZICM Button_rounded_6__tsqKR Button_maxContent__29WwM Button_small__ZiSjz Button_btn__z_3IU click'>
                <div
